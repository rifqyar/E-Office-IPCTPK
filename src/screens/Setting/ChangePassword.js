...
import {FormChangePassword} from '../../components/Setting/Index'
        ...
        <ImageBackground source={background} style={{flex:1}}>
            <LinearGradient colors={[COLORS.transparent, 'rgba(0,0,0,0.7)']} style={{flex: 1}}>
                <View style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                    <Title style={{...FONTS.h3, fontWeight: 700, textAlign: 'center', marginBottom: SIZES.padding*3}}>Form Change Password</Title>
                    <Surface style={styles.formContainer} elevation={4}>
                        <FormChangePassword navigation={navigation} user={user} />
                    </Surface>
                </View>
